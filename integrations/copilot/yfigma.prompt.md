---
mode: agent
description: Implement from a Figma design using the yasuda-figma-mcp (yfigma_*) read-only tools — local render, no public S3.
---
...
Follow our existing code conventions and design-system naming. All `yfigma_*` tools are
**read-only** — this plugin does not modify Figma files. Works in Design mode, Dev Mode, and
FigJam.
